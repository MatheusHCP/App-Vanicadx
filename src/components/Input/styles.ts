...
import { iconPosition, InputProps } from './types';
...
export const IconContainer = styled.View<Pick<InputProps, 'iconPosition'>>`
  ...
  padding-left: ${({iconPosition}) => {return iconPosition == 'right' ? '10' : '0'}}px;
  padding-right: ${({iconPosition}) => {return iconPosition == 'left' ? '10' : '0'}}px;
